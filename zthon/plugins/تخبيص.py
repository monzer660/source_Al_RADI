...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامر جديده🎸](t.me/SOURSE_Al_Rady) .\n\n**⎉اليك عزيزي الاوامر الجديده :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامر جايه 🎸](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.سينزر تاج راسك`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المكالمـات والميـوزك 🎸](t.me/SOURSE_Al_Rady) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/SOURSE_Al_Rady) .
**- الامـر :**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات النظــام 🤖](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر نظـام البـوت المسـاعد :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه 🛗](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر مكـافح التكــرار 🛡](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المنــع 🚫](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافه والتفليـش 👾](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات 🧬](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الوقتــي 🕰](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الفحـص 🏮](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فـارات السـورس 🛰](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات بعـض اوامـر فـارات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه 🏂](t.me/SOURSE_Al_Rady) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التحشيش 🎃](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.بلاي`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الحســاب 🚹](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات الاوامـر المتعلقـه بالحسـاب :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر حمـايــة الخــاص 🛡](t.me/SOURSE_Al_Rady) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فــارات حمـايــة الخــاص 🛡](t.me/SOURSE_Al_Rady) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المـرفقــات 🖥](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الستـوريـات 🎆🏖](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.بنات`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الادوات 💡](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات الروابــط 💡](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/SOURSE_Al_Rady) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & التشيكـر ❇️](t.me/SOURSE_Al_Rady) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميـع النقـاط 💡](t.me/SOURSE_Al_Rady) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/SOURSE_Al_Rady) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗘𝗟 𝗥𝗔𝗗𝗬 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر النشــر التلقــائي 🌐](t.me/SOURSE_Al_Rady  ) .
**- الامـر :**
**⪼** `.تلقائي`
