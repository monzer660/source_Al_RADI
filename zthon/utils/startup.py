    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس الراضي الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗦َِ𝗼َِ𝗨َِ𝗿َِ𝗖َِ𝗲 َِ𝗘𝗟 𝗥𝗔𝗗𝗬", "https://t.me/SOURSE_Al_Rady"),)],
...
zthon = {"@SOURSE_Al_Rady", "@KENJI_6", "@AlR_ady_5", "@TNT_source", "@Monzer_rashq", "@TNT_source"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "كـروب السجـل الراضي", zedub, Config.TG_BOT_USERNAME, descript, photozed
