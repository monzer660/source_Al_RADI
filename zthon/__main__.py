...
LOGS = logging.getLogger("سورس الراضي")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["KENJI_6","AlR_ady_5","HELP_SOURSE_Al_Rady","SOURSE_Al_Rady_VISA","SOURSE_Al_Rady","Monzer_rashq","TNT_source","SOURSE_Al_Rady","TNT_source","VisaTepthon","zszxzz"]
    ...
    print(f"⌔┊تـم تنصيـب الراضي . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()
